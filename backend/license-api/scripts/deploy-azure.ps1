...
Write-Host "OneNote-Katalog: zusätzlich Notes.Read.All (Application) auf der Betreiber-App."
Write-Host "Optional: CATALOG_LIBRARY_NAME, CATALOG_KURSTEAM_PATH, CATALOG_MATERIALS_ROOT, CATALOG_ONENOTE_NOTEBOOK"
Write-Host "Materialien: GET/PUT/DELETE catalog/materials (+ /file, /folder)"
Write-Host "OneNote: GET catalog/onenote/notebooks|…/tree|sections/…/pages|pages/…/preview|sections/…/export"
